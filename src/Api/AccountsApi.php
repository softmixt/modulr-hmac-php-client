...
class AccountsApi
{
     ...
     * @param double $min_balance Accounts with balance equal or more than this amount (optional)
     * @param double $max_balance Accounts with balance equal or less than this amount (optional)
